				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="bigg"></td>
							</tr>
						</table>
					</center>
				</div>
...
if (isset($_POST['remove1']))
  ...
  ?>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>DreamCatchers</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = $conn->query("SELECT * FROM `product` WHERE category='bigg' ORDER BY product_id DESC") or die(mysqli_error());
 ...
 $row = $result->fetch_array();
  ...
  echo "<script>window.location = 'admin_DC.php'</script>";
  //header("Location:admin_DC.php");
 }
