...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="small"></td>
							</tr>
						</table>
					</center>
				</div>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>(DC)KeyChains</h2></center></div>
			<br />
 ...
 $row = $result->fetch_array();
  ...
  echo "<script>window.location = 'admin_DCK.php'</script>";
  //header("Location:admin_DCK.php");
 }
